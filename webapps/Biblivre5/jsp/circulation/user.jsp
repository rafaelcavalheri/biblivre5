<script>(function(){function f(v,m){var d=new Date(v);if(isNaN(d))return v;var o=m=="D"?{year:"numeric",month:"long",day:"numeric",weekday:"long",timeZone:"America/Sao_Paulo"}:{year:"numeric",month:"long",day:"numeric",weekday:"long",hour:"2-digit",minute:"2-digit",timeZone:"America/Sao_Paulo"};return new Intl.DateTimeFormat("pt-BR",o).format(d)};window._d=f})();</script>
